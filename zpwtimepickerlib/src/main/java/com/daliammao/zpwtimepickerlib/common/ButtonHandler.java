package com.daliammao.zpwtimepickerlib.common;
...
public class ButtonHandler implements View.OnClickListener {
    ...
    public ButtonHandler(@NonNull DateTimePicker sublimePicker) {
    ...
    private void initializeForLandscape(DateTimePicker sublimeMaterialPicker) {
    ...
    public void updateSwitcherText(@NonNull Options.Picker displayedPicker, CharSequence text) {
        if (mIsInLandscapeMode) {
            if (displayedPicker == Options.Picker.DATE_PICKER) {
                mSwitcherButtonDP.setText(text);
            } else if (displayedPicker == Options.Picker.TIME_PICKER) {

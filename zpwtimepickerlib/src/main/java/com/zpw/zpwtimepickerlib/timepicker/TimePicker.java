...
//        }
     ...
     * com.zpw.zpwtimepickerlib.timepicker's values.
     *
     * @param allowEmptyDisplay if true, then if the typedTimes is empty, use the placeholder text.
     *                          Otherwise, revert to the com.zpw.zpwtimepickerlib.timepicker's values.
     */
    ...
    private final OnFocusChangeListener mFocusListener = new OnFocusChangeListener() {
        ...
        public void onFocusChange(View v, boolean hasFocus) {
            if (!hasFocus && mInKbMode && isTypedTimeFullyLegal()) {
                ...
                if (mOnTimeChangedListener != null) {
                    mOnTimeChangedListener.onTimeChanged(TimePicker.this,
